...
void REG_VELOCITY(uint32_t canId, bool extended, uint8_t servoId, FlexCAN_T4<CAN1, RX_SIZE_256, TX_SIZE_16>* can);
...
void REG_STREAM_MODE(uint32_t canId, bool extended, uint16_t servoId, uint16_t periodMs, FlexCAN_T4<CAN1, RX_SIZE_256, TX_SIZE_16>* can);
